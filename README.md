...
![image](https://github.com/user-attachments/assets/f7832d15-e886-4718-ab38-3fce0f8beebd)
...
Потом обязательно нужно импортировать все нужные модули. Во-первых, сам Flask, а во-вторых, для сайта понадобиться render_template (рис. 1_2).  
 ...
 ![image](https://github.com/user-attachments/assets/980afebd-0827-42e1-84a7-3ba163797484)
...
Следующем шагом будет создание директории под названием templates, это будет директория с различными шаблонами. Создавать директорию следует на том же уровне, где и находиться ваш файл с тем самым расширением “.py” (рис. 1.3). 
 ...
 ![image](https://github.com/user-attachments/assets/bb29cb92-0b01-4218-a3a7-b2bc94cec0d4)
...
![image](https://github.com/user-attachments/assets/cf564875-9380-4f2d-9f80-2cdcaad0c2af)

(рис 1.4) 

Теперь можно приступать к созданию функций в Flask (рис.1.5). 

![image](https://github.com/user-attachments/assets/e42b1c4e-6c53-4bef-9e8f-d73269b73d50)
...
![image](https://github.com/user-attachments/assets/7bd1bcd9-3405-408a-8863-abee3d59be37)
...
![image](https://github.com/user-attachments/assets/4e23a240-2b8b-4834-a95e-f665ca8ee294)
...
После создаём директорию и называем её templates, эта директория будет хранить в себе HTML-шаблоны, то есть шаблоны с расширением “.html” (рис. 2.3). 
 ...
 ![image](https://github.com/user-attachments/assets/9c499a66-a015-4013-8b3d-0c9bc171ab20)
...
Теперь создаём две переменные с названием app и templates. Переменная app будет содержать в себе класс FastAPI, а templates будет содержать Jinja2Templates с указанным путём в папку с шаблонами (рис. 2.4). 
 ...
 ![image](https://github.com/user-attachments/assets/3d2af22b-49fd-402f-868f-06d316007903)

(рис. 2.4) 

А сейчас можно непосредственно переходить к самим функциям (рис. 2.5). 

 ![image](https://github.com/user-attachments/assets/e1657083-013f-4d35-a88b-c4448dfdc320)
...
![image](https://github.com/user-attachments/assets/9ee8d3f6-0e2f-4909-a32c-69c624998226)

(рис. 3.1) 

![image](https://github.com/user-attachments/assets/9040b2b9-ac71-4899-9d67-45e8d9ebedcc)
...
![image](https://github.com/user-attachments/assets/ad16d5bc-8d69-49c4-ac5a-abcd10d45460)

     (рис. 3.3.1)

![image](https://github.com/user-attachments/assets/3a15e291-a95a-465e-b13b-02981c65cb4a)
...
![image](https://github.com/user-attachments/assets/c30daa96-e699-43bb-a350-307ac2be598b)

(рис. 3.4) 

Теперь в TEMPLATES, а конкретнее в листе “DIRS” нужно прописать вашу папку с шаблонами с помощью BASE_DIR (рис. 3.5). 

![image](https://github.com/user-attachments/assets/0a94ca41-0b32-4da2-99fa-5c24eb68e066)
...
![image](https://github.com/user-attachments/assets/e5e488a2-3abc-452e-88e8-703382127327)
...
![image](https://github.com/user-attachments/assets/7c767c23-d73d-4ef0-a673-e40a3e32dc08)
...
![image](https://github.com/user-attachments/assets/29185dc0-94fc-424b-883c-0ebfb66c5b42)

(рис. 3.8)

![image](https://github.com/user-attachments/assets/97da5a72-ce0a-439f-a252-8f83316648a1)
...
![image](https://github.com/user-attachments/assets/57946a7a-f304-4010-9433-a5389036d157)

(рис. 4.1.1)

![image](https://github.com/user-attachments/assets/ba7d749a-1d92-4714-b786-a529e04f99df)
...
![image](https://github.com/user-attachments/assets/4358d964-4732-4f3d-ae29-ba171c8afd1d)

(рис. 4.2.1)

![image](https://github.com/user-attachments/assets/8c1fb130-8acd-45ad-8458-beb55d78bbf4)
